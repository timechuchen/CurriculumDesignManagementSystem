...
@WebServlet(name = "DowmSubmitFile", value = "/calDowmSubmitFile")
public class DowmSubmitFile extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String path = request.getSession().getServletContext().getRealPath("file\\studentSubmit");
